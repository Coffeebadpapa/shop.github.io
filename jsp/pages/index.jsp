...
<!-- Button trigger modal -->
    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModa2" style="position:absolute;left:97%;top:1px">
	<a href="back.jsp" style="text-decoration:none; color: white;">後臺管理</a></button>
	<%}else{%>
<!-- Button trigger modal -->
    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModa2" style="position:absolute;left:97%;top:1px">
	<a href="person.jsp" style="text-decoration:none; color: white;">會員專區</a></button>
	<%}%>
	 
    <button type="button" class="btn btn-primary" onclick="location.href='shoppingcar.jsp'" style="position:absolute;left:235px;top:1px;">預訂清單</button>

	<div style="position:absolute; width:130px;left:235px;top:3px">網站瀏覽人數：<%out.print(count);%></div>
	<div class="contain" onclick="myFunction1()" style="position:absolute;left:370px;">
    <div class="bar1"></div>
    <div class="bar2"></div>
    <div class="bar3"></div>
    </div>
    <div class="dropdown" style="position:absolute;left:370px;top:27px">
...
<!-- Modal -->
    ...
    <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"data-bs-toggle="modal"data-bs-target="#exampleModa2">還沒註冊</button>
...
<!--網站瀏覽計數器--!>	
    ...
    <!-- Button trigger modal -->
    <button type="button" class="btn btn-primary" onclick="location.href='shoppingcar.jsp'">預訂清單</button>
	<div style="position:absolute; width:130px;left:235px;top:3px">網站瀏覽人數：<%out.print(count);%></div>
    ...
    <div class="carousel-item active">
        <a href="product.jsp?TP01" target="_blank"> <img src="../assets/images/ad1.png" class="d-block w-100" alt="..."></a>
    </div>
    <div class="carousel-item">
        <a href="product.jsp?YL01" target="_blank"><img src="../assets/images/ad2.png" class="d-block w-100" alt="..."></a>
    </div>
    <div class="carousel-item">
        <a href="product.jsp?HI01" target="_blank"><img src="../assets/images/ad3.png" class="d-block w-100" alt="..."></a>
    </div>
    </div>
    ...
    <form method="GET" action="search.jsp">
      <div class="container">
          ...
          <input type="search" id="search"name="searchtext" placeholder="你想去哪裡？">
          <div class="submit">
    ...
    <div class="text">快速選單</div>
     <a href="hproduct.jsp?location=基隆 Keelung">
        <button class="quickbtn">基隆</button></a>
    <a href="hproduct.jsp?location=台北 Taipei">        
        <button class="quickbtn">台北</button></a>
    <a href="hproduct.jsp?location=新北 NewTaipei">
        <button class="quickbtn">新北</button></a>
    <a href="hproduct.jsp?location=宜蘭 Yilan">
        <button class="quickbtn">宜蘭</button></a>
    <a href="hproduct.jsp?location=桃園 Taoyuan">
        <button class="quickbtn">桃園</button></a>
    <a href="hproduct.jsp?location=新竹 Hsinchu">
    ...
    <div class="p_text1">新北 NewTaipei</div>
	<a href="hproduct.jsp?location=新北 NewTaipei">
        <img src="../assets/images/taipei2.jpeg" class="photo2"></a>
		
    <div class="p_text2">基隆 Keelung</div>
	<a href="hproduct.jsp?location=基隆 Keelung">
        <img src="../assets/images/keelung.png" class="photo3"></a>
		
    <div class="p_text3">桃園 Taoyuan</div>
	<a href="hproduct.jsp?location=桃園 Taoyuan">	
        <img src="../assets/images/taoyuan.png" class="photo4"></a>
		
    <div class="p_text4">新竹 Hsinchu</div>
	<a href="hproduct.jsp?location=新竹 Hsinchu">
        <img src="../assets/images/hsinchu.png" class="photo5"></a>
